...
var useDelayedRender = function (delay) {
    var _a = useState(true), delayed = _a[0], setDelayed = _a[1];
    useEffect(function () {
...
var Loading = function (_a) {
    ...
    var theme = useTheme();
    return (React.createElement(DelayedRender, { delay: delay },
        React.createElement(Grid, { container: true, justify: "center", alignItems: "center", style: {
                height: '100%',
                textAlign: 'center',
...
var render = function (Comp, props) {
    return isReactComponent(Comp) ? React.createElement(Comp, __assign({}, props)) : Comp;
};
...
var StyledMuiBackdrop = withStyles(function (theme) { return ({
    root: {
...
var LoadingOverlay = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(DelayedRender, { delay: delay },
            React.createElement(StyledMuiBackdrop, { open: true },
                React.createElement(CircularProgress, { style: { marginLeft: theme.spacing(9) } }))),
        render(children, restProps)));
};

export { DelayedRender, Loading, LoadingOverlay };
