...
//             //     console.log('groupal:', form.getValues().justifications);
//             //     const msg =
//             //       !!Object.values(form.getValues().justifications).some(el => !!el) || 'Required';
...
//               <Checkbox
//                 key={el.name}
//                 name={`justifications[${el.name}]`}
//                 label={el.label}
//                 rules={{
//                   validate: () => {
//                     console.log('form.getValeus():', form.getValues());
//                     // const groupValues = getFormGroupValues(form.getValues(), 'justifications');

//                     // console.log('groupal:', groupValues);
//                     // if (idx !== 0) return true;
//                     return (
//                       !!Object.values(form.getValues().justifications).some(el => !!el) ||
//                       'Required'
//                     );
//                   }
//                 }}
